...
// TODO Auto-generated catch block
    ...
    public Trans getTransState(long taskid) throws SQLException, ClassNotFoundException {
        //声明Connection对象
        ...
        try {
            ...
            while (rs.next()) {
                ...
                long endTime_L=getTime(endTime);
                 trans=new Trans(taskid,taskid,transname,Status,endTime_L);
                //输出结果
            }
            rs.close();
          //  connection.close();
    ...
    public long run(int type,String filename) throws IOException, InterruptedException {
        ...
        String KTRFileName=rewriteKTR(timestamp,filename);
